...
class NlgalNlgalSpectrum(LingalLingalSpectrum):
    ...
    def set_power(self, block, bin1, bin2):
        ...
        #Aquí es donde se construye Pgg (k,z) combinando los términos de Fast-PT con los valores de bias para cada bin.
        #get_PXX get the terms from the data block that fast-pt calculated.
        #fast-pt just generates the power spectra components, cosmosis then combines/adds them with the correct bias values.
